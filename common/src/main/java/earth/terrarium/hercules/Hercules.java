...
public class Hercules {
    ...
    public static final ResourceKey<Registry<Criterion>> CRITERION_REGISTRY_KEY = ResourceKey.createRegistryKey(new ResourceLocation(Hercules.MOD_ID, "quests/criterion"));
    ...
    public static void grantCriteria(ServerPlayer player, Stream<Holder<Criterion>> criterion) {
