...
public class EditTasksQuestScreen extends AbstractQuestScreen {
    ...
    protected GridLayout initSidebar(AtomicInteger row) {
        addRenderableWidget(Widgets.button()
            ...
            .withCallback(() -> CreateObjectModal.open("tasks", this::createTask, this::isValidCreation, getValidTypes()))
            .withRenderer(WidgetRenderers.text(Component.literal("Add Task")))
