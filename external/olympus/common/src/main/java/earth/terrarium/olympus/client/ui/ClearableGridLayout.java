...
public class ClearableGridLayout extends AbstractLayout {
	...
	public void arrangeElements() {
		...
		for(CellInhabitant inhabitant : this.cellInhabitants) {
	...
	public <T extends LayoutElement> T addChild(T child, int row, int column, LayoutSettings settings) {
		this.cellInhabitants.add(new CellInhabitant(child, row, column, settings));
	...
	static class CellInhabitant extends AbstractChildWrapper {
		final int row;
		final int column;
