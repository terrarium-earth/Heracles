...
import earth.terrarium.olympus.client.components.base.BaseWidget;import net.minecraft.client.Minecraft;
...
public class DropdownEntry<T> extends BaseWidget implements ListWidget.Item {
    ...
    private static final ResourceLocation ENTRY =  Heracles.id("textures/gui/sprites/dropdown/entry.png");
    private static final ResourceLocation ENTRY_HOVERED =  Heracles.id("textures/gui/sprites/dropdown/entry_hovered.png");
