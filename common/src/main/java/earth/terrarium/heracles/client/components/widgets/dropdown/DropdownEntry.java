...
public class DropdownEntry<T> extends BaseWidget implements ListWidget.Item {
    ...
    private static final ResourceLocation ENTRY =  Heracles.id("dropdown/entry");
    private static final ResourceLocation ENTRY_HOVERED =  Heracles.id("dropdown/entry_hovered");
